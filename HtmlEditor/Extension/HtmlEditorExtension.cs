...
{
    internal static class HtmlEditorExtension
    {
        /// <summary>
        /// 撤销命令是否可执行
        /// </summary>
        ...
        /// 执行打印命令
        /// </summary>
        public static void Print(this HtmlDocument document)
        {
            document.ExecuteCommand("print", false, null);
        }
        /// <summary>
        /// 执行设为右对齐命令
        /// </summary>
        ...
        /// 执行插入文本命令
        /// </summary>
        public static void InsertText(this HtmlDocument document, string html)
        {
            document.ExecuteCommand("Cut", false, null);
        ...
        public static Color GetFontColor(this HtmlDocument document)
        {
            ...
            return Tool.StringToColor(document.QueryCommandValue("ForeColor").ToString());
        }
        ...
        {
            if (document.State != HtmlDocumentState.Complete) return Colors.Black;
            return Tool.StringToColor(document.QueryCommandValue("BackColor").ToString());
        }
