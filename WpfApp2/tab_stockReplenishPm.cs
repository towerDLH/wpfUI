namespace WpfApp2
{
    ...
    public partial class tab_stockReplenishPm
    {
        [Key]
        public Guid stockReplenishPm_id { get; set; }
        ...
        [StringLength(50)]
        public string replenishOrder { get; set; }
        ...
        public decimal? ThisTimeReplenishNum { get; set; }
