namespace WpfApp2
{
    ...
    public partial class tab_stockReceivedPmRecord
    {
        [Key]
        ...
        public decimal? practicalReceivedNum { get; set; }

        public decimal? ThisTimepracticalReceivedNum { get; set; }
        ...
        public int? consumptionNum { get; set; }

        [StringLength(50)]
        public string pmrecordcode { get; set; }
    }
}
