namespace WpfApp2
{
    ...
    public partial class tab_acpout_tr_dtl
    {
        [Key]
        ...
        public decimal? acpout_qty { get; set; }

        public decimal? realout_qty { get; set; }
        ...
        public decimal? std_noout_qty { get; set; }

        public decimal? std_acpreal_qty { get; set; }
