namespace WpfApp2
{
    ...
    public partial class tab_BomTemplate
    {
        [Key]
        public Guid BomTemplate_id { get; set; }

        public Guid? ParentBomTemplate_id { get; set; }
        ...
        public Guid? parentPattern { get; set; }

        public Guid? SelfPattern { get; set; }

        public Guid? upper_item_id { get; set; }

        [StringLength(50)]
        public string upper_item_cd { get; set; }

        [StringLength(50)]
        public string uppe_item_name { get; set; }

        public long? use_seq { get; set; }

        public Guid? lower_item_id { get; set; }

        [StringLength(50)]
        public string lower_item_cd { get; set; }
