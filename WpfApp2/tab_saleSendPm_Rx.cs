namespace WpfApp2
{
    ...
    public partial class tab_saleSendPm_Rx
    {
        [Key]
        public Guid saleSendPm_id { get; set; }

        [StringLength(50)]
        public string saleSendPm_code { get; set; }
        ...
        public Guid? saleSendPmWh { get; set; }
        ...
        public decimal? NotoutSendNum { get; set; }

        public decimal? predictSendNum { get; set; }

        public decimal? salePackNum { get; set; }
