namespace WpfApp2
{
    ...
    public partial class tab_salesReturnPmNumInforma
    {
        [Key]
        public Guid saleReturnPmNumInforma_id { get; set; }

        public Guid? saleReturnPmNumInforma_code { get; set; }
        ...
        public decimal? SumReturnPmNum { get; set; }
